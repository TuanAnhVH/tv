...
<?php 
    $dh = new donhang();
    $l= $dh->db_get_list_donhang_by_year((int)$year);
    $lctt= $dh->db_get_list_donhang_by_year_ctt((int)$year);
    $ldtt= $dh->db_get_list_donhang_by_year_dtt((int)$year);
  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
    <div class="card ">
      <div class="card-header bg-primary text-white text-center">
          <h3> <?php echo 'Thống kê đơn hàng năm '.$year?> </h3>
      </div>
      <div class="card-body">
