...
<div id="content">
 ...
 <!-- <form action="<?php echo $nh->h->get_url('tv/?m=common&a=home&tl=thanhtoantc')?>" id="frmthanhtoan"  method="post"> -->
 <form action="#" id="frmthanhtoan"  method="post">
        ...
        <button class="btnthanhtoan"><a href="<?php echo $nh->h->get_url('tv/?m=common&a=home&tl=giohang&i=gh');?>">Giỏ hàng</a></button>
