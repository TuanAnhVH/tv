<?php
   ...
   $lst = $new->db_get_list_sanpham_paging_user_by_nhanhieu($paging_html,$id,$tl);

    $lst_all= $new->db_get_list_sanpham_by_nhanhieu($id);
    $nhanhieu2= $nhanhieu->db_get_list_nhanhieu_by_id($id);
    if(!empty($nhanhieu2))
        $nhanhieu3= $nhanhieu2['tennhanhieu'];
...
<div id="content">
<div>
<h1 style="margin-top: 10px; margin-bottom:10px;"><?php if(isset($nhanhieu3)) echo $nhanhieu3 ?></h1>
    <ul>
        ...
        <li>
            ...
            <div>
                ...
                <h3 style="color: black;"><?php echo "Thương hiệu: ".$row['tennhanhieu']?></h3>
                    ...
                    for($i=1;$i<=$trang;$i++)
                        {
                            ...
                            echo '<a style=" opacity:'.$o.'; text-decoration: none; color:'.$color.';" 
                                href="'.$new->h->get_url('tv/?m=common&a=home&tl=nhanhieu&id='.$id.'&page='.$i).'">.
                                </a>';  
                        }
            }
        ?>
